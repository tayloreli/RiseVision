 ...
 */
function rebootDisplay() {
    console.log('rebootDisplay');
    // getting parameter values
    var _id = document.getElementById('rebootDisplay_id').value;
    var _fields = document.getElementById('rebootDisplay_fields').value;
    ...
    gapi.client.load(API_NAME, API_VER, function () {
        ...
        request.execute(function (jsonResp, rawResp) {
            handlesResponse(jsonResp, rawResp, 'rebootDisplayResult');
        });
    }, ROOT);
}