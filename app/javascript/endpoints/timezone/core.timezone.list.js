...
function listTimezone() {
    ...
    var _fields = document.getElementById('listTimezone_fields').value;
    ...
    gapi.client.load(API_NAME, API_VER, function () {
        ...
        var request = gapi.client.core.timezone.list(parameters);

        // jsonResp object has got a duplication of the data which comes under result element
        request.execute(function (jsonResp, rawResp) {
            handlesResponse(jsonResp, rawResp, 'listTimezoneResult');
        })
    }, ROOT);
}